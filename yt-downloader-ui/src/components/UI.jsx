...
export function Select({ label, value, onChange, options, small = false }) {
  return (
...
export function TextField({ label, placeholder, value, onChange }) {
  return (
...
export const Kbd = ({ children }) => <kbd className="px-2 py-1 text-xs font-semibold text-slate-800 bg-slate-100 border border-slate-200 rounded-md dark:bg-slate-900 dark:text-slate-200 dark:border-slate-700">{children}</kbd>;